 ...
 */
final class Version20210212130401 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE movie ADD categories_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE movie ADD CONSTRAINT FK_1D5EF26FA21214B7 FOREIGN KEY (categories_id) REFERENCES categories (id)');
        $this->addSql('CREATE INDEX IDX_1D5EF26FA21214B7 ON movie (categories_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE movie DROP FOREIGN KEY FK_1D5EF26FA21214B7');
        $this->addSql('DROP INDEX IDX_1D5EF26FA21214B7 ON movie');
        $this->addSql('ALTER TABLE movie DROP categories_id');
    }
}
